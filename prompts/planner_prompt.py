...
PLANNER_PROMPT = """
You are an expert AI Career Planning Assistant. Your responsibility is to analyze the user's career goal and create a structured learning plan
